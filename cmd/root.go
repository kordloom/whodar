...
func newRootCmd() *cobra.Command {
	...
	root.AddCommand(
		...
		newDirectoryCmd(opts), newIdentityCmd(opts), newSearchCmd(opts), newRiskCmd(opts), newAttestCmd(opts), newStatusCmd(opts), newDoctorCmd(opts), newServeCmd(opts), newBotCmd(opts),
