...
func newRootCmd() *cobra.Command {
	...
	root.AddCommand(
		...
		newDirectoryCmd(opts), newIdentityCmd(opts), newSearchCmd(opts), newRiskCmd(opts), newOwnershipCmd(opts), newAttestCmd(opts), newStatusCmd(opts), newDoctorCmd(opts), newServeCmd(opts), newBotCmd(opts),
